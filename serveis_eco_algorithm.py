...
class ServeisEcosistemicsAlgorithm(QgsProcessingAlgorithm):
    """
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterFeatureSink('CapaResultat', 'Capa resultat', type=QgsProcessing.TypeVectorAnyGeometry,
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        outputs['Buffer500MetresCanals'] = processing.run('native:buffer', alg_params, context=context,
        ...
        outputs['Buffer50MetresCanals'] = processing.run('native:buffer', alg_params, context=context,
                                                         feedback=feedback, is_child_algorithm=True)
        ...
        outputs['ExtractByExpression'] = processing.run('native:extractbyexpression', alg_params, context=context,
                                                        feedback=feedback, is_child_algorithm=True)
        ...
        outputs['ClipLulcUrba50MCanals'] = processing.run('native:clip', alg_params, context=context, feedback=feedback,
        ...
        outputs['ClculHaDeSlUrb'] = processing.run('native:fieldcalculator', alg_params, context=context,
                                                   feedback=feedback, is_child_algorithm=True)
        ...
        outputs['SelecciUhd'] = processing.run('qgis:selectbyexpression', alg_params, context=context,
                                               feedback=feedback, is_child_algorithm=True)
        ...
        outputs['ClculHpd'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback,
                                             is_child_algorithm=True)
        ...
        outputs['ClipLulcUrba50050MCanals'] = processing.run('native:clip', alg_params, context=context,
                                                             feedback=feedback, is_child_algorithm=True)
        return results
    ...
    def createInstance(self):
        return ServeisEcosistemicsAlgorithm()
